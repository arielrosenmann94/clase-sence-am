...
while opcion != "5":
    ...
    print("2. Buscar cliente por nombre completo")
    print("3. Eliminar cliente por ID")
    print("4. Mostrar listas de clientes")
    print("5. Salir")
    ...
    if opcion == "1":
        ...
        cliente = next((c for c in clients if c["id"] == id_buscar), None)
        print(cliente if cliente else "Cliente no encontrado.")

    elif opcion == "2":
        nombre_buscar = input("Ingrese el nombre completo: ")
        cliente = next((c for c in clients if c["nombre_completo"].lower() == nombre_buscar.lower()), None)
        print(cliente if cliente else "Cliente no encontrado.")
        ...
        for i, cliente in enumerate(clients):
            if cliente["id"] == id_eliminar:
                clientes_eliminados.append(clients.pop(i))
                print(f"Cliente {cliente['nombre_completo']} movido a la lista de eliminados.")
                break
        else:
        ...
        for c in clientes_eliminados: print(c)
