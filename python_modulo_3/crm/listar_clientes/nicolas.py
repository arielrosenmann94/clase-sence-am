...
for client in clients:
    if client["estado"] == "Cliente potencial":
        cliente_potencial.append(client["nombre_completo"])
    elif client["estado"] == "Cliente efectivo":
        cliente_efectivo.append(client["nombre_completo"])
    elif client["estado"] == "Alto interés":
        cliente_interesado.append(client["nombre_completo"])
    elif client["estado"] == "Super cliente":
        cliente_super.append(client["nombre_completo"])
    elif client["estado"] == "En proceso de compra":
        en_proceso_de_compra.append(client["nombre_completo"])


print("cliente_potencial:  "  ,cliente_potencial)
print("cliente_efectivo:  "  ,cliente_efectivo)
print("cliente_interesado:  "  ,cliente_interesado)
print("cliente_super:  "  ,cliente_super)
print("en_proceso_de_compra:  ",en_proceso_de_compra)