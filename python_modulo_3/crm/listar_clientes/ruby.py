...
print("LISTADO TOTAL")
print(f"{'ID':<4} | {'NOMBRE':<20} | {'ESTADO'}")
print("-" * 50)

for cliente in clients:
    print(f"{cliente['id']:<4} | {cliente['nombre_completo']:<20} | {cliente['estado']}")

estado_filtro = "Alto interés"
print(f"\nLISTADO POR ESTADO: {estado_filtro}")
print(f"{'ID':<4} | {'NOMBRE':<20} | {'CORREO'}")
print("-" * 50)

for cliente in clients:
    if cliente['estado'] == estado_filtro:
        print(f"{cliente['id']:<4} | {cliente['nombre_completo']:<20} | {cliente['correo']}")