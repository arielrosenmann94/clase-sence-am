...
while confirmation == "s":
    ...
    print("\nSeleccione una categoría para buscar:")
    ...
    if choice not in options:
        ...
        continue   
    searcher = options[choice]
    searcher_value = input(f"Ingrese el {searcher} del cliente: ").lower()
    ...
    for client in clients:
        ...
        if searcher == "id":
            if str(client["id"]) == searcher_value:
                print(f"Se ha localizado al usuario {client['nombre_completo']} a través del buscador ID")
                encontrado = True

        else:
            if searcher_value in client[searcher].lower():
                print(f"Se ha localizado al usuario {client['nombre_completo']} a través del buscador {searcher}, cuyo id es {client['id']}")
                encontrado = True
